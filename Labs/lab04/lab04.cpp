...
void renderScene(void)  {
	...
	positionListener(cameraX, cameraY, cameraZ,
					 cameraDirX, cameraDirY, cameraDirZ,
					 0.0f, 1.0f, 0.0f);

    /* TODO #??: Place our moving sources every frame */
	positionSource(sources[1], cameraX + cameraDirX*cameraRadius, cameraY + cameraDirY*cameraRadius, cameraZ + cameraDirZ*cameraRadius);
...
int main( int argc, char *argv[] ) {
	...
	positionListener(cameraX, cameraY, cameraZ, cameraDirX, cameraDirY, cameraDirZ, 0.0f, 1.0f, 0.0f);
	positionSource(sources[2], cameraX, cameraY, cameraZ);
